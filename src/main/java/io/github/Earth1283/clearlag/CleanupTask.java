...
public class CleanupTask implements Runnable {
    ...
    @Override
    public void run() {
        // This code runs asynchronously, initiated by the timer or command.
        // However, Bukkit API calls that interact with the world (like getting entities or removing them)
        // must be done on the main server thread.

        // Schedule the main cleanup logic to run synchronously on the main thread.
        Bukkit.getScheduler().runTask(plugin, () -> {
            ...
            // This message sending should also happen on the main thread.
            if (!isManualCommand) {
            ...
            if (isManualCommand) {
                ...
                if (commandSender != null) {
                    commandSender.sendMessage(postCleanupMessage);
                }
